...
# 下载中文字体（Streamlit Cloud 服务器没有中文字体）
...
# 字体已在文件开头动态下载并注册 (Noto Sans CJK SC)
# plt.rcParams['axes.unicode_minus'] = False
...
with st.sidebar:
    ...
    benchmark_code = st.text_input("基准代码(akshare)", value="sh000300", 
...
if st.session_state.raw_df is not None and not st.session_state.calc_done:
    ...
    if calc_clicked:
        ...
        # 使用列表推导替代 groupby apply，避免 pandas 2.2+ 兼容性问题
        metrics_list = []
